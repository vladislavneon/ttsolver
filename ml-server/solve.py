...
from simple_search import find_best_single_choice, best_recalls
import random
    ...
    for question in questions:
        ...
        if question.question_type == QuestionType.single:
            ...
            if best_choice[2] != -1:
                ...
                answers.append(Answer(question.question, AnswerVerdict.found_area, question.options, choices, line_number))
        else:
